# TODO
- [ ] Track the Phase 0 hierarchical knowledge view definition migration described in `docs/design/KNOWLEDGE_VIEW_DEFINITION_MIGRATION.md`, with optional back-porting if the current release needs it.
